...
<script>
    var options = {
        ...
        modelRandMode: "${settings.live2d_modelRandMode!'switch'}",
        modelTexturesRandMode: "${settings.live2d_modelTexturesRandMode!'rand'}",
        ...
        takagiSize: "${settings.live2d_takagiSize!'280x250'}",
        takagiTipsSize: "${settings.live2d_takagiTipsSize!'250x70'}",
        takagiFontSize: "${settings.live2d_takagiFontSize!'12px'}",
        takagiToolFont: "${settings.live2d_takagiToolFont!'14px'}",
        takagiToolLine: "${settings.live2d_takagiToolLine!'20px'}",
        takagiToolTop: "${settings.live2d_takagiToolTop!'0px'}",
        takagiMinWidth: "${settings.live2d_takagiMinWidth!'768px'}",
        takagiEdgeSide: "${settings.live2d_takagiEdgeSide!'left:0'}",
        takagiDraggable: "${settings.live2d_takagiDraggable!'disable'}",
        takagiDraggableRevert: ${(settings.live2d_takagiDraggableRevert!true)?string('true','false')},
        l2dVersion: "${settings.live2d_l2dVersion!'1.0.0'}",
        l2dVerDate: "${settings.live2d_l2dVerDate!'2020.07.01'}",
        homePageUrl: "${blog_url!'auto'}",
        aboutPageUrl: "${settings.live2d_aboutPageUrl!'https://lixingyong.com/s/halo-live2d'}",
        screenshotCaptureName: "${settings.live2d_screenshotCaptureName!'live2d.png'}"
    }
    initModel("", options)
</script>
</#macro>